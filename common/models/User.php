 ...
 *
 * @mixin UploadImageBehavior $avatar
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            self::SCENARIO_UPDATE => ['username', 'email', 'password', 'status', 'avatar'],
            self::SCENARIO_INSERT => ['username', 'password', 'email', 'status'],
        ];
    }
    ...
    public function behaviors()
    {
        return [
            ...
            [
                ...
                'url' => Yii::$app->params['hosts.front'] . Yii::getAlias('/upload/user/{id}'),
                'thumbs' => [
                    self::AVATAR_ICO => ['width' => 30, 'height' => 30, 'quality' => 90, 'bg_color' => '000'],
                    self::AVATAR_CHAT => ['width' => 40, 'height' => 40, 'quality' => 90, 'bg_color' => '000'],
                    self::AVATAR_PREVIEW => ['width' => 200, 'height' => 200, 'bg_color' => '000'],
                ],
            ],
        ];
    }
